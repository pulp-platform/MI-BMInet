...
#    *train last epochs 8 channels SS using the 64-ch SS model instead of global model
...
results_dir=f'SS-TL_v5/{cs_model.NO_selected_channels}ch'
        ...
        for sub_idx in test_global:
            ...
            for train_sub, test_sub in kf_subject.split(X_sub, y_sub):
                ...
                if not cs_csp and not cs_eeg:
                    ...
                    model_global = load_model(f'SS-TL/64ch/model/subject{sub_str}_fold{sub_split_ctr}.h5')
