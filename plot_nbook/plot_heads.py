...
n_ch_list = [16, 24, 32] #[2, 3, 5, 7, 9, 11, 4, 6, 10, 14, 18, 20]#[8, 19, 38, 64] # number of channels {8,19,27,38,64}
...
same_folds = True
figsavepath= './plots/channels_head_plots/cubeedgeEEGNet_headset'
