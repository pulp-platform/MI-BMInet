...
def plot_memory_accuracy(n_ch_vec, num_classes, kernel_length, NO_samples, pool_length, NO_subjects):
    ...
    plt.title(f'Inter-Subject (MM) Memory vs Accuracy ({num_classes} Class, {NO_subjects} Subjects)')
...
def plot_ram_accuracy(results_dir, n_ch_vec, n_ds_vec, T_vec, num_classes):
    ...
    plt.title(f'Inter-Subject (MM) RAM vs Accuracy ({num_classes} Class)')
    plt.xlabel('Memory (kB)')
    plt.ylabel('Accuracy')
...
def plot_avg_global(num_classes, n_ch, T, n_ds, results_dir):
    ...
    plt.plot(train_accu, label='Training')
    plt.plot(valid_accu, label='Validation')
    plt.title(f'Inter-Subject MM Global Accuracy (classes={num_classes}, {n_ch}ch, ds={n_ds}, T={T}s)')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.grid()
    ...
    plt.plot(train_loss, label='Training')
    plt.plot(valid_loss, label='Validation')
    plt.title(f'Inter-Subject MM Global Loss (classes={num_classes}, {n_ch}ch, ds={n_ds}, T={T}s)')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    plt.grid()
