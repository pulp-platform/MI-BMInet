        ...
        for T in T_vec:
            for n_ds in n_ds_vec:
                ...
                for train, test in kf.split(X_Train_real, y_Train):
                    ...
                    os.makedirs(f'data_cubeai', exist_ok=True)
                    np.save(f'data_cubeai/{num_classes}class_mm_intra_xtest_split{split_ctr}.npy', X_Train_cs[test])
                    np.save(f'data_cubeai/{num_classes}class_mm_intra_ytest_split{split_ctr}.npy', y_Train_cat[test])
