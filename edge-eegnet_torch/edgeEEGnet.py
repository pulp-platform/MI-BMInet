...
class edgeEEGNet(t.nn.Module):
    ...
    def __init__(self, F1=8, D=2, F2=None, C=22, T=1125, N=4, p_dropout=0.5, reg_rate=0.25,
        ...
        # Block 1
        self.conv1 = t.nn.Conv2d(1, D * F1, (C, 1), bias=False)
        self.batch_norm1 = t.nn.BatchNorm2d(D * F1, momentum=0.01, eps=0.001)
        self.conv2_pad = t.nn.ZeroPad2d((31, 32, 0, 0))
        self.conv2 = t.nn.Conv2d(D * F1, D* F1, (1, 64), groups=D * F1, bias=False)
