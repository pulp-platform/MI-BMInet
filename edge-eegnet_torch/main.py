"""
Main function for edgeEEGnet, work in progress...
"""
...
from edgeEEGnet_controller import train_subject_specific, train_subject_specific_cv, \
    train_subject_specific_quant
from edgeEEGnet_controller import test_model_from_keras
...
def main():
    ...
    """
    print(f'MAIN.PY of edgeEEGNet - quantized: {QUANTIZED}')
    if TEST_KERAS_MODEL:
        acc = np.zeros((9,))
        for subject in range(1, 10):
