...
class edgeEEGNetQuant(t.nn.Module):
    """
    edgeEEGNetQuant
    """
    def __init__(self, qconfig, F1=16, D=1, F2=None, C=22, T=1125, N=4, p_dropout=0.5,
        ...
        """
        super(edgeEEGNetQuant, self).__init__()
        ...
        self.conv1_bn = t.nn.intrinsic.qat.ConvBnReLU2d(1, D * F1, (C, 1), momentum=0.01,
                                                        qconfig=qconfig)
        self.conv2_bn_relu = t.nn.intrinsic.qat.ConvBn2d(D * F1, D * F1, (1, 64), padding=(0, 31),
                                                         groups=D * F1, momentum=0.01, qconfig=qconfig)
