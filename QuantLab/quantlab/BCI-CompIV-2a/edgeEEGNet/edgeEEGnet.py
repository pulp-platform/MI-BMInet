...
class edgeEEGNet(t.nn.Module):
    """
    Quantized edgeEEGNet
    """

    def __init__(self, F1=16, D=1, F2=None, C=22, T=1125, N=4, Nf=64, p_dropout=0.5,
        ...
        self.conv1 = conv2d("conv1", 1, F1, (C, 1), bias=False)
        ...
        self.conv2 = conv2d("conv2", F1, F1*D, (1, Nf), bias=False, groups=F1,
                            numLevels=weightFirstLayerNumLevels, first=True)
        self.batch_norm2 = t.nn.BatchNorm2d(F1*D, momentum=0.01, eps=0.001)
