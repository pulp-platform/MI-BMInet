...
def get_data(logbook, cv_fold=None, subj_indexes=None, num_workers=10):
    ...
    if cv_fold is None:
        ...
        torch.manual_seed(1234+cv_fold)
    # load preprocessed datasets
    train_set, valid_set, test_set = logbook.module.load_data_sets(logbook.dir_data, data_config, subj_indexes, cv_fold)
