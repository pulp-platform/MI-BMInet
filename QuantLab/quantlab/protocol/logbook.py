...
class Logbook(object):
    ...
    def _set_folders(self, exp_id):
        ...
        if self.verbose:
            # print setup message
            self.message  = 'EXPERIMENT LOGBOOK\n'
            self.message += 'Problem:               {}\n'.format(self.problem)
            self.message += 'Network topology:      {}\n'.format(self.topology)
            self.message += 'Data directory:        {}\n'.format(self.dir_data)
            self.message += 'Log directory:         {}\n'.format(self.dir_logs)
            self.message += 'Checkpoints directory: {}\n'.format(self.dir_saves)
            self.message += 'Statistics directory:  {}\n'.format(self.dir_stats)
    ...
    def _get_config(self):
        ...
        if self.verbose:
            self.message += 'Config Path:           {}\n'.format(private_config_file)
            # self.message += 'Subject:               {}\n'.format(self.config['treat']['data']['subject'])
