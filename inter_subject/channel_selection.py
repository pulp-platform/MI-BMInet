...
def channel_selection_eegweights_fromglobal(NO_channels, NO_selected_channels, NO_classes, split_ctr, n_ds, T, results_dir):
	...
	'''
	model_global = load_model(f'{results_dir}/model/global_class_{NO_classes}_ds{n_ds}_nch64_T{T}_split_{split_ctr}_v1.h5')
